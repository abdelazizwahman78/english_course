...
$query_count = "SELECT COUNT(*) AS total FROM tblcourse";
$result_count = mysqli_query($con, $query_count);
$row_count = mysqli_fetch_assoc($result_count);
$total_records = $row_count['total'];
$total_pages = ceil($total_records / $records_per_page);

$q="select * from  tblcourse  order by cname  LIMIT $offset, $records_per_page";
...
echo"<td >$cname";
echo"<td >$level";
echo "<td><a href='Update_Course.php?cid=$cid' class='btn-login' )'>Update</a></td>";
echo "<td><a href='delete_Course.php?cid=$cid' class='btn-login' onclick='return confirm(\"Are you sure you want to delete this  Course?\")'>Delete</a></td>";
