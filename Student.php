    ...
    <div class="container">
      ...
      <div class=" layout_padding2">
        <div class="card-deck">
          <div class="card">
          <div class="card-body">
            <a href="ListNew_Student.php"><h2>New Users</h2></a>
            </div>         
         </div>
          <div class="card">
            <div class="card-body">
              <a href="Approved_list.php"><h2>Approved Users</h2></a>
            </div>
          </div>
          <div class="card">
            <div class="card-body">        
            <a href="NotApproved_list.php"><h2>Not Approved Users</h2></a>
            </div>
          </div>
          <div class="card">
          <div class="card-body">
            <a href="Result_Student.php"><h2>Users Result</h2></a>
            </div>         
         </div>
      </div>
    </div>
