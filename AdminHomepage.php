    ...
    <div class="container">
      ...
      <div class=" layout_padding2">
        <div class="card-deck">
          <div class="card">
          <div class="card-body">
            <a href="Student.php"><h2> User</h2></a>
            </div>         
         </div>
          <div class="card">
            <div class="card-body">        
            <a href="Course.php"><h2>Course</h2></a>
            </div>
          </div>
          <div class="card">
            <div class="card-body">               
                <a href="Test.php"><h2> Test</h2></a>
            </div>
          </div>
        </div>
      </div>
      <div class=" layout_padding2">
        <div class="card-deck">
          <div class="card">
            <div class="card-body">        
            <a href="AdminUpdateProfile.php"><h2>Update Profile</h2></a>
            </div>
          </div>
          <div class="card">
            <div class="card-body">        
            <a href="AdminChangePassword.php"><h2>Change Password</h2></a>
            </div>
          </div>
        </div>
      </div>
