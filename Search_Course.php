                    ...
                    <table class="tb-search" style="display:flex">
                       ...
                       ?>
                            ...
                            <td>
                                ...
                                <a href="ListTest.php"><input type="button" value="Clear"
...
$Qid=$_POST['Qid'];
$q="select * from  tblcourse C, tblquizque Q where C.cid=Q.cid and Q.Qid='$Qid'";
...
echo"<td >$cname";
echo"<td >$Category";
echo "<td><a href='Quiz_List.php?Qid=$Qid' class='btn-login' )'>Quiz</a></td>";
echo"</tr>";
