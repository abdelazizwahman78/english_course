...
$qryname = "select * from  tbladmin where aname='$UserID' ";
$result= mysqli_query($con,$qryname);
      ...
      <div class="row">
        <div class="col-lg-6 col-12 mx-auto">
          ...
          <div class="p-5 bg-white rounded shadow-lg" style="width:687px !important;">
            ...
            <form action="AdminProfile_Code.php" method="post">
                <table>
                    <tr>
                        <td><label for="">Admin ID</label>
                            <input type="text" name="aid" class="form-control form-control-lg mb-3" value="<?php echo $aid ?>" readonly>                       				
                          </td>
                        <td><label for="">Admin Name</label>
                            <input type="text" name="aname" class="form-control form-control-lg mb-3"  value="<?php echo $aname ?>" maxlength="50" id="" pattern="[a-zA-Z ]+" placeholder="Enter Your First Name" required title="Please enter a name using only letters" style="width:300px;height:45px;padding:15px" required>
                        </td>
                    </tr>
                    <tr>
