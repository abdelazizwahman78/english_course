...
<br/><br/><br/><br/><br/>
  <h1 align="center"> Users Result </h1>
...
$query_count = "SELECT COUNT(*) AS total FROM tbltakequiz";
$result_count = mysqli_query($con, $query_count);
$row_count = mysqli_fetch_assoc($result_count);
$total_records = $row_count['total'];
$total_pages = ceil($total_records / $records_per_page);

$q="select * from  tbltakequiz T,  tblquizque Q,tblstudent S, tblcourse C where  Q.cid=C.cid and T.Qid=Q.Qid and T.sid=S.sid LIMIT $offset, $records_per_page";
