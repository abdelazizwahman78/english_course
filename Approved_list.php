...
<br/><br/><br/><br/><br/>
  <h1 align="center">Approved Users List </h1>
...
$q="select * from  tblstudent where status='1'  order by Sfname  LIMIT $offset, $records_per_page";
...
echo"<td >$phone";
echo"<td >$status";
echo "<td><a href='delete_Student1.php?sid=$sid' class='btn-login' onclick='return confirm(\"Are you sure you want to delete this Student?\")'>Delete</a></td>";
