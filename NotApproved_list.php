...
<body>
  ...
  <br/><br/><br/><br/>
  <h1 align="center">Not Approved Users list</h1>
...
$q="select * from  tblstudent where status='0'  order by Sfname  LIMIT $offset, $records_per_page";
...
echo"<td >$phone";
echo"<td >$status";
echo "<td><a href='delete_Student.php?sid=$sid' class='btn-login' onclick='return confirm(\"Are you sure you want to delete this Student?\")'>Delete</a></td>";
...
echo"</table><br>";
	...
	echo "<center>No   Student Yet! <br>";
	echo "Click <a href='Student.php'>here</a> To Back !</a></center>";
}
?>
